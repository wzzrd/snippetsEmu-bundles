...
exec "Snippet ifnotnotequal {% ifnotequal ".st.et." ".st.et." %}<CR>".st.et."<CR>{% endifnotequal %}<CR>".st.et
...
exec "Snippet else {% else %}<CR>".st.et
...
exec "Snippet with {% with ".st.et." as ".st.et." %}<CR>".st.et."<CR>{% endwith %}<CR>".st.et
