...
exec "Snippet doctype <!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01//EN\"<CR>\"http://www.w3.org/TR/html4/strict.dtd\"><CR>".st.et
...
exec "Snippet html <html>".st.et."<CR></html>"
...
exec "Snippet script <script type=\"text/javascript\"><CR>// <![CDATA[<CR>".st.et."<CR>// ]]><CR></script><CR>".st.et
...
exec "Snippet link <link rel=\"".st.et."\" href=\"".st.et."\" type=\"text/css\" media=\"".st.et."\" />"
